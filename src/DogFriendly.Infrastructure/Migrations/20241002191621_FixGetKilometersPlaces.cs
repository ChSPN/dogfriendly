...
{
	/// <inheritdoc />
	public partial class FixGetKilometersPlaces : Migration
	{
		/// <inheritdoc />
		...
		{
			migrationBuilder.Sql(@"DROP FUNCTION IF EXISTS GetKilometersPlaces(double precision, double precision, double precision);");
		}
	}
}
